...
export async function generateMetadata(): Promise<Metadata> {
    return {
        ...
        alternates: { canonical: "https://swiftscale.com.ng/seo-consultations" },
        openGraph: {
            type: "article",
                ...
                <JsonLd
                    ...
                    data={{
                        ...
                        itemListElement: [
                            ...
                            { "@type": "ListItem", position: 3, name: "SEO Consultations", item: "https://swiftscale.com.ng/seo-consultations" }
                        ]
                    }}
                />
                <SEOConsulting />
