...
export default async function RootLayout({ children, ...props }: PropsWithChildren) {
    ...
    return (
        <html lang="en">
            ...
            <body
                className={`body-scale ${inter.className} ${monumentExtended.variable} h-screen w-screen overflow-scroll bg-white text-black dark:bg-custom-black dark:text-white fixed top-0 left-0`}
            >
