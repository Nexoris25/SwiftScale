  ...
  return (
    <section className="relative w-full h-[600px] flex items-center justify-start overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-start justify-center h-full px-8 max-w-2xl">
        ...
        <button onClick={() => navigate.push("/contact")} className="bg-[#6A01E1] text-white border font-poppins px-8 py-2 rounded-full text-lg hover:bg-purple-700 transition-colors duration-300">
          Get in Touch
        </button>
      </div>
    </section>
