  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center gap-4 w-full">
          ...
          {theme === "dark" ? (
            <>
              <Instagram
                ...
                className="w-12 lg:w-16 h-12 lg:h-16 cursor-pointer"
                aria-hidden="true"
              />
              <Facebook
                onClick={() =>
        ...
        {/* Cards */}
        <div
          className="grid grid-cols-1 lg:grid-cols-4 gap-10 mt-2 p-10 max-lg:px-4"
          role="list"
          aria-label="List of legal services"
        >
          {services.map((item, index) => (
            <div
              key={index}
              className="bg-gray-50 rounded-2xl p-5 shadow-sm hover:shadow-md transition-all duration-300 flex flex-col items-start min-h-[180px] max-lg:min-h-[120px]"
              role="listitem"
            >
              <div className="mb-4">
