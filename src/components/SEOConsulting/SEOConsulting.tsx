    ...
    return (
        ...
        >
            ...
            <img
                ...
                alt=""
                aria-hidden="true"
                className="absolute w-full max-w-[1000px] h-auto -bottom-0 rotate-[20deg] max-lg:hidden z-0 pointer-events-none"
            />
            ...
            <div className="relative z-10 flex flex-col items-center gap-4 w-full">
                ...
                {/* PARAGRAPH — WRAPS NATURALLY ON DESKTOP */}
                <p className="text-black dark:text-white/80 text-center mb-8 max-w-3xl leading-relaxed">
                    Have a consultation with us, let us know how we can help you boost your online presence
                ...
                {/* IMAGE — FULL ON MOBILE, CONTAINED ON DESKTOP */}
                <div className="w-full flex flex-row mt-2 max-lg:px-0 px-10 justify-center items-center">
                    <img
                        src={typeof DImage2 === "string" ? DImage2 : DImage2.src}
                        alt="SEO consulting banner"
                        className="rounded-xl w-full object-cover max-lg:h-[280px] lg:max-h-[600px]"
                    />
                </div>
            </div>
        </section>
